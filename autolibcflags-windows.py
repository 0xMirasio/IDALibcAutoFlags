...
class AutoLibcFlags(idaapi.plugin_t):
    ...
    def init(self):
        ...
        if p_initialized is False:
            ...
            idaapi.register_action(idaapi.action_desc_t(
                ...
                None,
                0))
            print(f"AutoLibcFlags Windows Version {VERSION} | Thibault Poncetta")
            self.enum = {}
    ...
    def sanityCheck(self):
        ...
        self.enum_cache = user + "/IdaAutoLibcFlags/"
        if os.path.exists(self.enum_cache):
            return 0
        else:
            print("Didn't not find enum cache ! Please install plugins with ./install.bat script")
            return 1
